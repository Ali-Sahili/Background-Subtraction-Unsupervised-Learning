...
dataloader_mask = DataLoader(dataroot_mask, image_size, image_size, batch_size, workers, Allow_Shuffle=Allow_Shuffle)
...
losses, img_list, heat_maps_list, model = train(dataloader, dataloader_mask)
